...
urlpatterns = [
    ...
    path('get-mun/', views.ListarMunicipio.as_view(), name="get-mun" ),
    path('get-verdas/', views.ListarVereda.as_view(), name="get-veredas" ),
    path('get-subtaciones/', views.ListarSubestacion.as_view(), name="get-subtaciones" ),
    path('get-circuitos/', views.ListarCircuito.as_view(), name="get-circuitos" ),
]
