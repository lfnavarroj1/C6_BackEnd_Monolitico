    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('responsable_scm', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('odms', models.ManyToManyField(to='work_management.odm')),
            ],
        ),
        migrations.CreateModel(
            name='Nodo',
        ...
        migrations.AddField(
            ...
            name='trabajo',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='work_management.trabajo'),
        ),
        migrations.CreateModel(
            name='Libreto',
            fields=[
